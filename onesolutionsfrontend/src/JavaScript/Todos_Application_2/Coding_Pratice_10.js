...
const Coding_Pratice_10 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice10 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-coding-practice-10"
    );
    if (practice10) {
...
export default Coding_Pratice_10;
