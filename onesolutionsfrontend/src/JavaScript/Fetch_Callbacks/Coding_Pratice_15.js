...
const Coding_Pratice_15 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice15 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-coding-practice-15"
    );
    if (practice15) {
...
export default Coding_Pratice_15;
