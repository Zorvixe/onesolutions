...
const Coding_Pratice_14 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice14 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-coding-practice-14"
    );
    if (practice14) {
...
export default Coding_Pratice_14;
