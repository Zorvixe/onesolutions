...
const questionsData = [
    {
      question: (
        <div>
          <p>1. What is the main purpose of the <code>fetch()</code> method in JavaScript?</p>
        </div>
      ),
      options: [
    ...
    },
    {
      question: (
        <div>
          <p>2. Which method is used to handle successful responses from a fetch request?</p>
          <CodeBlock
            language="javascript"
    ...
    },
    {
      question: (
        <div>
          <p>3. What is the correct syntax to handle errors in a fetch request?</p>
          <CodeBlock
            language="javascript"
    ...
    },
    {
      question: (
        <div>
          <p>4. In Fetch & Callbacks 2, what does the <code>method</code> property define in fetch options?</p>
        </div>
      ),
      options: [
    ...
    },
    {
      question: (
        <div>
          <p>7. What is the main purpose of the <code>event.preventDefault()</code> method in form handling?</p>
        </div>
      ),
      options: [
      ...
      answer: "It prevents the default browser action like page reload on form submit"
    },
    {
      question: (
        <div>
          <p>8. Which input type is used for selecting one option from a list of predefined choices?</p>
          <CodeBlock
            language="html"
  ...
  <input type="radio" name="gender" value="female"> Female`}
    ...
    },
    {
      question: (
        <div>
          <p>9. Which of the following correctly represents a drop-down menu in HTML?</p>
          <CodeBlock
            language="html"
    ...
    },
    {
      question: (
        <div>
          <p>10. What does the <code>checked</code> attribute do in an HTML input element?</p>
        </div>
      ),
      options: [
...
const JS_MCQ_Assignment_1 = () => {
  return <MCQLogic title="JS Assignment 4 - MCQs" questions={questionsData} />;
};
