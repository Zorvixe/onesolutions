  ...
  useEffect(() => {
    const JS_Coding_Assignment_2 =
      javascriptCodingPracticesData.javascript.find(
        (p) => p.id === "javascript-JS_Coding_Assignment_2"
      );
    if (JS_Coding_Assignment_2) {
      setSelectedPractice(JS_Coding_Assignment_2);
      console.log("✅ Loaded practice:", JS_Coding_Assignment_2.id);
    }
    setLoading(false);
...
export default JS_Coding_Assignment_2;
