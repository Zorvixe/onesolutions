  ...
  useEffect(() => {
    const JS_Coding_Assignment_3 =
      javascriptCodingPracticesData.javascript.find(
        (p) => p.id === "javascript-JS_Coding_Assignment_3"
      );
    if (JS_Coding_Assignment_3) {
      setSelectedPractice(JS_Coding_Assignment_3);
      console.log("✅ Loaded practice:", JS_Coding_Assignment_3.id);
    }
    setLoading(false);
...
export default JS_Coding_Assignment_3;
