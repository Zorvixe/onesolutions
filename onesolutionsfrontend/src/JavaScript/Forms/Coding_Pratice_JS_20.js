...
const Coding_Pratice_JS_20 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice20 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-coding-practice-20"
    );
    if (practice20) {
      setSelectedPractice(practice20);
      console.log("✅ Loaded practice:", practice20.id);
    }
    setLoading(false);
...
export default Coding_Pratice_JS_20;
