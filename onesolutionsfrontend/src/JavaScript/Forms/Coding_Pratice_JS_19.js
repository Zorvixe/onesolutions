...
const Coding_Pratice_JS_19 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice19 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-coding-practice-19"
    );
    if (practice19) {
      setSelectedPractice(practice19);
      console.log("✅ Loaded practice:", practice19.id);
    }
    setLoading(false);
...
export default Coding_Pratice_JS_19;
