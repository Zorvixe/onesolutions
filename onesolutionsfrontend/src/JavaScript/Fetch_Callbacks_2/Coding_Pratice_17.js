...
const Coding_Pratice_JS_17 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice17 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-coding-practice-17"
    );
    if (practice17) {
...
export default Coding_Pratice_JS_17;
