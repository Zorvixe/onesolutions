...
const Coding_Pratice_JS_18 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice18 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-coding-practice-18"
    );
    if (practice18) {
...
export default Coding_Pratice_JS_18;
