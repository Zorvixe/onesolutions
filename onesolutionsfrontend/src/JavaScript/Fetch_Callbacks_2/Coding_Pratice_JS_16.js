...
const Coding_Pratice_JS_16 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice16 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-coding-practice-16"
    );
    if (practice16) {
...
export default Coding_Pratice_JS_16;
