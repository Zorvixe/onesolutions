...
const Coding_Test_4 = () => {
  ...
  // Load practice
  useEffect(() => {
    const Coding_Test_4 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-JS_Coding_Test_4"
    );
    if (Coding_Test_4) {
      setSelectedPractice(Coding_Test_4);
      console.log("✅ Loaded practice:", Coding_Test_4.id);
    }
    setLoading(false);
