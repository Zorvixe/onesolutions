...
const JS_Coding_Test_1 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice41 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-coding-test-1"
    );
    if (practice41) {
      setSelectedPractice(practice41);
      console.log("✅ Loaded practice:", practice41.id);
    }
    setLoading(false);
...
export default JS_Coding_Test_1;
