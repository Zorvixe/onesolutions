...
const Coding_Test_2 = () => {
  ...
  // Load practice
  useEffect(() => {
    const Coding_Test_2 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-JS_Coding_Test_2"
    );
    if (Coding_Test_2) {
      setSelectedPractice(Coding_Test_2);
      console.log("✅ Loaded practice:", Coding_Test_2.id);
    }
    setLoading(false);
