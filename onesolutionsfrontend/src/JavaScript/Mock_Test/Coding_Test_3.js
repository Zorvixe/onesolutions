...
const Coding_Test_3 = () => {
  ...
  // Load practice
  useEffect(() => {
    const Coding_Test_3 = javascriptCodingPracticesData.javascript.find(
      (p) => p.id === "javascript-JS_Coding_Test_3"
    );
    if (Coding_Test_3) {
      setSelectedPractice(Coding_Test_3);
      console.log("✅ Loaded practice:", Coding_Test_3.id);
    }
    setLoading(false);
