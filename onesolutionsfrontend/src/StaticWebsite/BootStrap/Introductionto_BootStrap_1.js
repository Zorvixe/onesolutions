...
const Introductionto_Bootstrap_1 = ({
  subtopicId,
  goalName,
  courseName,
  subtopic,
  moduleName = "Bootstrap",
  topicName = "Introduction to Bootstrap Part 1",
  slidesUrl = "https://docs.google.com/presentation/d/1_BHNPj2Nl_cCCqpL7q1OcBDF1T-AGP1qNTq_DpakKdI/embed",
}) => {
...
export default Introductionto_Bootstrap_1;
