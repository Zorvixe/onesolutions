...
const Static_Website_Project = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice12 = staticCodingPracticesData.static.find(
      (p) => p.id === "Build-Your-Own-Static-Website-Project"
    );
    if (practice12) {
...
export default Static_Website_Project;
