...
const Static_Course_Exam_Instruction = ({
  subtopicId,
  goalName,
  courseName,
  subtopic,
  moduleName = "Build Your Own Static Website Course Exam",
  topicName = "Build Your Own Static Website Course Exam | Instructions",
  slidesUrl = "https://docs.google.com/presentation/d/17Ys39kEW2RFQmwafS8iQAalv3wP-72nwtc_YfIdaF8Y/embed",
}) => {
...
export default Static_Course_Exam_Instruction;
