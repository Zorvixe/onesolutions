...
const Static_Coding_Pratice_7 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice7 = staticCodingPracticesData.static.find(
      (p) => p.id === "static-coding-practice-7"
    );
    if (practice7) {
...
export default Static_Coding_Pratice_7;
