...
const questionsData = [
  {
    question: (
      <div>
        <p>
          What is required for this carousel to work correctly when multiple
          carousels exist?
        </p>
        <CodeBlock
          language="html"
          code={`<div id="goldenTempleCarousel" class="carousel slide">
  <div class="carousel-inner">
    ...
    options: [
      "Same id as others",
      "Unique id across the page",
      "No id needed",
      "id starting with 'section'",
    ],
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock
          language="html"
          code={`<div class="card" onclick="display('sectionMysorePalace')">
  <img src="mysore.jpg">
  <h3>Mysore Palace</h3>
</div>`}
        />
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock
          language="html"
          code={`<button onclick="display('sectionFavouritePlaces')" class="btn btn-primary">
...
<div id="carousel3" class="carousel"></div>`}
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock
          language="html"
          code={`<div onclick="display('sectionVaranasi')">Varanasi Card</div>`}
        />
      </div>
    ),
    options: [
      ...
      "Step 2: Add HTML",
      "Step 3: Add onclick to the card",
  ...
  {
    question:
      "In the integration process, what must be added to go back from Golden Temple Detailed View?",
    options: [
      "A button with onclick to sectionHome",
      "A button with onclick to sectionFavouritePlaces",
...
const Website_Integration_MCQ_2 = ({ subtopicId, goalName, courseName }) => {
