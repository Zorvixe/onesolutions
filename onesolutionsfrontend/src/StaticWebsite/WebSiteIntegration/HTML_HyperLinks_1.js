...
const Html_HyperLinks_1 = ({
  subtopicId,
  goalName,
  courseName,
  subtopic,
  moduleName = "Website Integration",
  topicName = "HTML Hyperlinks",
  slidesUrl = "https://docs.google.com/presentation/d/15WvucJyOuCSvuRm_rDj7_gvpvq9YXnTwK0YIOkPYaJQ/embed",
}) => {
...
export default Html_HyperLinks_1;
