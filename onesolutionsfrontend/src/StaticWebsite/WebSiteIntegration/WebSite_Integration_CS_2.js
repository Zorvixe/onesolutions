...
const WebSite_Integration_CS_2 = ({
  ...
  return (
    <div className="intro-container">
      ...
      <section>
        ...
        <p className="note">
          📝 IDs of the Carousels must be unique in the HTML document for
          controls to work.
        </p>
      </section>
      ...
      <section>
        ...
        <p>To display Detailed View Section when clicking a card:</p>
        <ol>
          <li>Add Section Container with unique id.</li>
          <li>Add Detailed View HTML.</li>
          <li>
            Add <code>onclick</code> to the card.
          </li>
          <li>Add a button in Detailed View Section to go back.</li>
          <li>
            Add <code>onclick</code> to the button.
          </li>
        </ol>
  ...
  <li>Playing Guitar</li>
        ...
        />
        <p>
          Style with <code>list-style-type</code>:
        </p>
        <CodeBlock
          language="css"
          code={`ul { list-style-type: disc; } /* circle, square, none */`}
        />
  ...
  <li>JavaScript</li>
        ...
        <CodeBlock
          language="css"
          code={`ol { list-style-type: decimal; } /* upper-alpha, lower-alpha, upper-roman, lower-roman, none */`}
        />
