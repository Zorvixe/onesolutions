  ...
  const mcqs = [
    {
      ...
      answer: "border-width",
      explanation:
        "The border-width property controls the thickness of the border. border-style must be specified for the border to be visible.",
    },
    {
      id: "border_radius",
      ...
      explanation:
        "border-bottom-left-radius rounds only the bottom-left corner. You can also use the shorthand border-radius with four values.",
    },
    {
      id: "border_color",
    ...
    },
    {
      ...
      answer: "border-style",
      explanation:
        "border-style is required to make the border visible (values: solid, dashed, dotted, none, etc.).",
    },
    {
      id: "padding",
      section: "Padding",
      ...
      answer:
        "Padding is the space surrounding the content of an HTML element.",
      explanation:
        "Padding creates inner spacing between the content and the border.",
    },
  ];
