...
const Static_Coding_Assignment_3 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice11 = staticCodingPracticesData.static.find(
      (p) => p.id === "Static-Coding-Assignment-3"
    );
    if (practice11) {
...
export default Static_Coding_Assignment_3;
