...
const Static_Coding_Assignment_2 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice10 = staticCodingPracticesData.static.find(
      (p) => p.id === "Static-Coding-Assignment-2"
    );
    if (practice10) {
...
export default Static_Coding_Assignment_2;
