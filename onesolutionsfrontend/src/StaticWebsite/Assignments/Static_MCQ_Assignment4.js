...
const questionsData = [
  // ========== 10 CodeBlock Questions – Website Integration (All Subtopics) ==========
  {
    question: (
      <div>
        ...
        <CodeBlock
          language="html"
          code={`<button class="btn btn-primary" onclick="display('sectionHome')">
  Go Home
</button>`}
        />
      </div>
    ...
    options: [
      "Page reloads",
      "Shows section with id='sectionHome'",
      "Opens link",
      "Nothing happens",
    ],
  ...
  <img src="https://d1tgh8fmlzexmh.cloudfront.net/ccbp-static-website/learn-technologies-img.png" />
    ...
    options: [
      "Because img is inside anchor",
      "Because of target='_blank'",
      "Because of alt text",
      "Only text can be links",
    ],
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock
          language="html"
          code={`<button onclick="display('sectionGallery')">Gallery</button>
<button onclick="display('sectionContact')">Contact</button>`}
  ...
  <h1>Welcome</h1>
    ...
    options: [
      "id must start with 'section'",
      "class must be 'container'",
      "Must use Bootstrap",
      "No requirement",
    ],
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock
          language="html"
          code={`<a href="https://cloudinary.com/" target="_blank" rel="noopener">
  Upload Image
</a>`}
        />
      </div>
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock
          language="html"
          code={`<a href="#sectionServices">Go to Services</a>
<div id="sectionServices">Our Services</div>`}
  ...
  Visit Site
    ...
    options: [
      "Because of href",
      "Because of target",
      "Because of rel='noopener noreferrer'",
  ...
  {
    question:
      "To navigate within the same page, use #sectionName in href and matching id on the section.",
    options: ["True", "False"],
    answer: "True",
  },
  {
    ...
    options: [
      "target='_blank'",
      "rel='noopener'",
      "Both target='_blank' and rel='noopener'",
      "href='_blank'",
    ],
