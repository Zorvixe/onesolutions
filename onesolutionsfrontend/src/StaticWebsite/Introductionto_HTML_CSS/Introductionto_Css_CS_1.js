...
const Introductionto_Css_CS_1 = ({
  ...
  <button>Get Started</button>
      ...
      <section>
        ...
        <h3>2. Syntax</h3>
        <p>
          Refer to the given CSS code and choose which of the following is a CSS
          Property.
        </p>
  ...
  text-align: right;
        ...
        {[
          {
            question:
              "Refer to the given CSS code and choose which of the following is a value for the CSS Property text-align",
