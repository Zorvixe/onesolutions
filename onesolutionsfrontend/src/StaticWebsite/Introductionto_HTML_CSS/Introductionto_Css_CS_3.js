...
const Introductionto_Css_CS_3 = ({ onSubtopicComplete }) => {
  ...
  return (
    <div className="intro-container">
      <h1>Introduction to CSS | Cheat Sheet | Part 3</h1>
...
p {
  font-family: "Times New Roman";
      ...
      <section>
        ...
        <ul>
          <li>
            You must add <code>px</code> after the number.
          </li>
  ...
  font-size: 20px;
      ...
      <section>
        ...
        <ul>
          <li>
            Valid values: <code>normal</code>, <code>italic</code>,{" "}
            <code>oblique</code>.
          </li>
  ...
  font-style: italic;
      ...
      <section>
        ...
        <ul>
          <li>
            Valid values: <code>normal</code>, <code>bold</code>,{" "}
            <code>bolder</code>, <code>lighter</code>, 100–900.
          </li>
          <li>No quotes required.</li>
        </ul>
...
p {
  font-weight: 600;
      ...
      <section>
        ...
        <ul>
          <li>
            Values: <code>underline</code>, <code>line-through</code>,{" "}
            <code>overline</code>.
          </li>
          <li>No quotes required.</li>
        </ul>
