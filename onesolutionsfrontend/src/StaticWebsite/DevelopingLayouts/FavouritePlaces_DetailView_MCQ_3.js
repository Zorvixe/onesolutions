...
const questionsData = [
  ...
  <div class="carousel-inner">
    ...
    options: ["Static images", "Slideshow cycling through images", "YouTube video", "Text description"],
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock language="html" code={`<div class="carousel-inner">
  <div class="carousel-item active">
  ...
  <div class="carousel-item">
    ...
    options: ["Change class to carousel-slide", "Add another <div class='carousel-item'> with new src", "Update heading", "Replace with iframe"],
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock language="html" code={`<div class="carousel slide">
  <div class="carousel-inner">
    ...
    options: ["They stay static", "They change every few seconds", "They play as video", "They require manual click"],
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock language="html" code={`<div class="carousel slide" id="myCarousel">
  <div class="carousel-inner">
    ...
  </div>
</div>`} />
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock language="html" code={`<iframe width="560" height="315" src="https://www.youtube.com/embed/dQw4w9WgXcQ?rel=0" frameborder="0" allowfullscreen></iframe>`} />
      </div>
    ),
    options: ["Changes the video", "Adds a new image", "Updates the heading", "Applies padding"],
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock language="html" code={`<iframe src="https://www.youtube.com/embed/VIDEO_ID?rel=0"></iframe>`} />
      </div>
    ),
  ...
  },
  {
    question: (
      <div>
        ...
        <CodeBlock language="html" code={`<!-- Replace this with YouTube embed -->
<div class="carousel slide">...</div>`} />
      </div>
    ),
    options: ["Add new images", "Update src attributes", "Use iframe with YouTube embed code", "Apply margin"],
  ...
  },
  {
    ...
    options: ["After ?rel=0", "After https://www.youtube.com/embed/", "Before the https", "Anywhere in the URL"],
    answer: "After https://www.youtube.com/embed/",
  },
  {
    question: "In the step-by-step process, what is done after adding the Bootstrap Carousel Code?",
    options: ["Add background image", "Update image URLs in the src attribute", "Replace with YouTube embed", "Apply padding only"],
