...
const Approachto_Develop_Layout_1 = ({
  subtopicId,
  goalName,
  courseName,
  subtopic,
  moduleName = "Developing Layouts",
  topicName = "Approach to Develop a Layout",
  slidesUrl = "https://docs.google.com/presentation/d/1ZIwh91tV4J0oNCVXdSDaJ7kBhe-GEIfpSdxJxFDTMB4/embed",
}) => {
...
export default Approachto_Develop_Layout_1;
