...
const Static_Coding_Pratice_5 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice5 = staticCodingPracticesData.static.find(
      (p) => p.id === "static-coding-practice-5"
    );
    if (practice5) {
...
export default Static_Coding_Pratice_5;
