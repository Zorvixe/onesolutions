...
const FavouritePlaces_DetailView_CS = ({
    ...
    <div className="intro-container">
      ...
      <section>
        ...
        <p>
          ...
          we used Bootstrap Carousel Component with Indicators.
        </p>
        <p>
          You can add different images in the Carousel by changing the image URL
          in the value of the HTML <code>src</code> attribute.
        </p>
    ...
    <div class="carousel-item">
      ...
      <section>
        ...
        <p>
          ...
          Bootstrap. You can add different Youtube videos by changing the Video
          ID in the value of the HTML <code>src</code> attribute.
        </p>
        <p>
          The Video ID is in between <code>https://www.youtube.com/embed/</code>{" "}
          and <code>?rel=0</code>.
        </p>
  ...
  <iframe src="https://www.youtube.com/embed/49HTIoCccDY?rel=0" title="YouTube video" allowfullscreen></iframe>
      ...
      <section>
        <h2>
          3. Step by Step Process to Develop Favourite Place Detailed View
        </h2>
        <ol>
          ...
          <li>
            Add the <code>src</code> attributes for the HTML <code>img</code>{" "}
          ...
          <li>
            Follow the same steps and replace Carousel with Youtube Embed to add
            video.
          </li>
        </ol>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          <code>?rel=0</code>. If any character is missed, the video won't load.
        </p>
      </section>
