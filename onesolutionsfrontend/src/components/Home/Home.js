    ...
    <div className="website">
      ...
      <div className="live">
        {liveClasses.length > 0 ? (
          ...
          <div className="no-classes">
            <p>No live classes scheduled for your batch at the moment.</p>
          </div>
        )}
      </div>
              ...
              >
                <div className="attendence-buttons">
                  ...
                  <div className="attendence-button">
                    <button
                      style={{
                        backgroundColor: "#e5e5fcde",
                        color: "#0404c8de",
                        borderColor: "#6f6feba6",
                        boxShadow: "none",
                      }}
                    >
                      Present
                  ...
                  <div className="attendence-button">
                    <button
                      style={{
                        backgroundColor: "#ffcdd271",
                        color: "#B71C1C",
                        borderColor: "#e9b0b0ff",
                        boxShadow: "none",
                      }}
                    >
                      Absent
      ...
      <div className="live">
        {achievementsLoading ? (
          ...
          <div className="no-classes">
            <p>No placement achievements to display.</p>
          </div>
        )}
      </div>
