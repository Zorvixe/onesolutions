const SQL_Coding_Pratice_1 = () => {
  return (
    <div>
      <h1>SqlCodingPratice1</h1>
    </div>
  );
};
export default SQL_Coding_Pratice_1;
...
// import { sqlCodingPracticeData } from "../../codingPracticesData/sqlCodingPracticeData";
...
//   // Load "Coding Practice - 1" from sqlCodingPracticeData
//   useEffect(() => {
//     const practice1 = sqlCodingPracticeData.python.find(
...
//           for (const practice of sqlCodingPracticeData.python) {
//             try {
...
//     navigate(`/sqlpractice/${selectedPractice.id}/${question.id}`, {
//       state: {
//         subtopicId: finalSubtopicId,
//         goalName,
//         courseName,
