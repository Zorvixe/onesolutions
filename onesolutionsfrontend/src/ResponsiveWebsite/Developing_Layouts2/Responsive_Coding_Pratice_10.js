...
const Responsive_Coding_Pratice_10 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice10 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-practice-10"
    );
    if (practice10) {
      setSelectedPractice(practice10);
      console.log("✅ Loaded practice:", practice10.id);
    }
    setLoading(false);
...
export default Responsive_Coding_Pratice_10;
