...
const Responsive_Coding_Pratice_11 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice11 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-practice-11"
    );
    if (practice11) {
...
export default Responsive_Coding_Pratice_11;
