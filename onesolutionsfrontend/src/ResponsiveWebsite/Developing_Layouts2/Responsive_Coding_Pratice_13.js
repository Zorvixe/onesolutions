...
const Responsive_Coding_Pratice_13 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice13 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-practice-13"
    );
    if (practice13) {
...
export default Responsive_Coding_Pratice_13;
