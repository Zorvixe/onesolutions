...
const Responsive_Coding_Test_2 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice22 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-test-2"
    );
    if (practice22) {
      setSelectedPractice(practice22);
      console.log("✅ Loaded practice:", practice22.id);
    }
    setLoading(false);
...
export default Responsive_Coding_Test_2;
