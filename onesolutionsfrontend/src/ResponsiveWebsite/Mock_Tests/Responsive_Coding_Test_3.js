...
const Responsive_Coding_Test_3 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice23 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-test-3"
    );
    if (practice23) {
      setSelectedPractice(practice23);
      console.log("✅ Loaded practice:", practice23.id);
    }
    setLoading(false);
...
export default Responsive_Coding_Test_3;
