...
const Responsive_Coding_Test_1 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice21 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-test-1"
    );
    if (practice21) {
      setSelectedPractice(practice21);
      console.log("✅ Loaded practice:", practice21.id);
    }
    setLoading(false);
...
export default Responsive_Coding_Test_1;
