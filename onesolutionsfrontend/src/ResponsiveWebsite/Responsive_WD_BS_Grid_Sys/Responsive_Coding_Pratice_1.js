...
const Responsive_Coding_Pratice_1 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice1 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-practice-1"
    );
    if (practice1) {
...
export default Responsive_Coding_Pratice_1;
