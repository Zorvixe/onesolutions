...
const Responsive_Coding_Pratice_16 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice16 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-practice-16"
    );
    if (practice16) {
      setSelectedPractice(practice16);
      console.log("✅ Loaded practice:", practice16.id);
    }
    setLoading(false);
...
export default Responsive_Coding_Pratice_16;
