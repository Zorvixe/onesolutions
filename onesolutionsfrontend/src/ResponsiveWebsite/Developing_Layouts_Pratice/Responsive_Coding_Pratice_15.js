...
const Responsive_Coding_Pratice_15 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice15 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-practice-15"
    );
    if (practice15) {
      setSelectedPractice(practice15);
      console.log("✅ Loaded practice:", practice15.id);
    }
    setLoading(false);
...
export default Responsive_Coding_Pratice_15;
