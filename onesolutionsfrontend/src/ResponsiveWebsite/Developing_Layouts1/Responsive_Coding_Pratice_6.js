...
const Responsive_Coding_Pratice_6 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice6 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-practice-6"
    );
    if (practice6) {
...
export default Responsive_Coding_Pratice_6;
