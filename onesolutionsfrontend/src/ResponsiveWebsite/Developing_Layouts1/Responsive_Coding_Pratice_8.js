...
const Responsive_Coding_Pratice_8 = () => {
  ...
  // Load practice
  useEffect(() => {
    const practice8 = responsiveCodingPracticesData.responsive.find(
      (p) => p.id === "responsive-coding-practice-8"
    );
    if (practice8) {
      setSelectedPractice(practice8);
      console.log("✅ Loaded practice:", practice8.id);
    }
    setLoading(false);
...
export default Responsive_Coding_Pratice_8;
