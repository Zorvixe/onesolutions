  ...
  return (
    <div className="intro-container">
      ...
      <section>
        ...
        <p> These are JavaScript functions that take props as a parameter if necessary
          and return a React element (JSX). </p>
        ...
        <ul>
           <li>Create an ES6 class that extends <code>React.Component.</code></li>
        ...
        <h4>1.2.1 extends</h4>
         <p>
            The <code>extends</code> keyword is used to inherit methods and properties
            from the <code>React.Component</code>.
         </p>

         <h4>1.2.2 render()</h4>
         <p>
             The <code>render()</code> method is the only required method in a class
             component. It returns the JSX element.
         </p>
...
class MyComponent extends Component {
 ...
 />
  ...
  <p>
    Use <code>this.props</code> in the render() body to access the props in a
    class component.
  </p>
...
<div className="Note-container">
  ...
  <ol>
    <li>React events are named using <b>camelCase,</b>rather than <b>lowercase.</b></li>
    <li>With JSX, you pass a <b>function</b> as the event handler instead of a <b>string.</b></li>
  </ol>
  ...
  <p>In the above function,the <code>handleClick</code>is called instead of passed as a reference.</p>
  ...
  />
  <p>In the above function, the <code>handleClick</code> is passed as a reference. So, the function is not being called every time the component renders.</p>

  <h3>Providing Arrow Functions</h3>
  <p>
  To not change the context of <code>this</code>, we have to pass an arrow function to the event.
  </p>
...
<section>
  <h2>3. State</h2>
  <p>
    State is a JavaScript object that stores the component's data that changes 
    over time.
  </p>
  ...
  <p>
    We can update the state using <code>setState()</code>. We can pass a function
    or object.
  </p>
  ...
  />
  <p>Here the previous state is sent as a parameter to the callback function.</p>
  ...
  <p>
    When updating state, only the specified key is updated. Other keys remain
    unchanged.
  </p>
...
state = { key1: value3, key2: value2 };`}
  ...
  <p>Use Class Components whenever the state is required.Otherwise,use the Functional Components.</p>
</section>
