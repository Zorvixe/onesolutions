    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          testCases: [
            { input: "pra49", output: "not a spcial string", visible: true },
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          testCases: [
            { input: "55\n5", output: "square root of A is not equal to B", visible: true },
            { input: "25\n5", output: "square root of A is equal to B", visible: true },
            { input: "25\n5", output: "square root of A is equal to B", visible: false },
            { input: "25\n5", output: "square root of A is equal to B", visible: false },
            { input: "25\n5", output: "square root of A is equal to B", visible: false },
          ],
          defaultCode: ``,
      ...
      questions: [
        {
          ...
          testCases: [
            ...
            { input: "60", output: "X is greater than 30\nX is greater than 50", visible: true },
        ...
        },
        {
          ...
          testCases: [
            ...
            { input: "8", output: "not top 3 but one of top 10", visible: true },
            { input: "4", output: "not top 3 but one of top 10", visible: false },
            { input: "4", output: "not top 3 but one of top 10", visible: false },
            { input: "6", output: "not top 3 but one of top 10", visible: false },
          ],
          defaultCode: ``,
          score: 10,
          status: "unsolved",
        ...
        },
        {
          ...
          testCases: [
            { input: "N\nY", output: "Allowed to Exam - Has Identification Card", visible: true },
            { input: "Y\nN", output: "allowed to exam - has hall ticket", visible: true },
            { input: "Y\nN", output: "allowed to exam - has hall ticket", visible: false },
            { input: "Y\nN", output: "allowed to exam - has hall ticket", visible: false },
            { input: "Y\nN", output: "allowed to exam - has hall ticket", visible: false },
          ],
          defaultCode: ``,
