      ...
      questions: [
        {
          ...
          title: "Custom Navbar",
          description: "In this assignment, let's build a Custom Navbar by applying the concepts we learned till now.",
          difficulty: "Easy",
          score: 25,
          type: "web",
          defaultCode: {
        ...
        },
        {
          ...
          description: "In this assignment, you will be applying the CSS Specificity concepts we learned till now.",
          difficulty: "Easy",
          score: 30,
          type: "web",
          defaultCode: {
          ...
          descriptionDetails: `
                <div class="desc-question-details">
                    <p class="desc-que-blue">Instructions</p>
                     <ol>
                        <li>Change the background color of the last two HTML paragraph elements to <strong>dodgerblue</strong> using the CSS class selector. The class name should be <strong>blue-bg</strong>.</li>
                        <li>Change the background color of the last HTML paragraph element to <strong>orange</strong> using the CSS class selector with an <strong>!important</strong> declaration. The class name should be <strong>orange-bg</strong> .</li>
                      </ol>
                    <div class="Note-container">
                  <div class="icon-note">
                    <h6>
