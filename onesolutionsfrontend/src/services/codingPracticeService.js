...
class CodingPracticeService {
  ...
  static async saveProgress(practiceId, questionId, language, code, status, score, attempt) {
    try {
      const response = await fetch(`${API_BASE_URL}/api/coding-practice/save-progress`, {
        method: "POST",
        headers: {
  ...
  static async getQuestionProgress(questionId) {
    try {
      const response = await fetch(`${API_BASE_URL}/api/coding-practice/question/${questionId}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
  ...
  static async getAllProgress() {
    try {
      const response = await fetch(`${API_BASE_URL}/api/coding-practice/progress`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
  ...
  static async completePractice(practiceId, goalName, courseName) {
    try {
      const response = await fetch(`${API_BASE_URL}/api/coding-practice/complete-practice`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${localStorage.getItem("token")}`,
  ...
  static async getCompletionStatus(practiceId) {
    try {
      const response = await fetch(`${API_BASE_URL}/api/coding-practice/completion/${practiceId}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
  ...
  static async getPracticeSummary(practiceId) {
    try {
      const response = await fetch(`${API_BASE_URL}/api/coding-practice/summary/${practiceId}`, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem("token")}`,
        },
      })
