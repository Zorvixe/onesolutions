  ...
  return (
    <div className="intro-container">
      ...
      <section>
        <h2>Block of Code</h2>
        <p>
          A sequence of instructions are called block of code. Python executes
          code in a sequence.
        </p>
      </section>
      ...
      <section>
        <h2>Condition</h2>
        <p>
          An expression that results in either <code>True</code> or{" "}
          <code>False</code>
        </p>
        <h3>Examples</h3>
        <ul>
          ...
          <li>a == b</li>{" "}
          {/* Kept as text; == is fine here but could use &eq; if needed */}
      ...
      <section>
        ...
        <p>
          Conditional Statement allows you to execute a block of code only when
          a specific condition is <code>True</code>
        </p>
        <img
      ...
      <section>
        ...
        <p>
          Block of code which executes only if a condition is <code>True</code>{" "}
      ...
      <section>
        ...
        <p>
          ...
          Indentation(spacing) is used to identify Conditional Block. Standard
          practice is to use four spaces for indentation.
        </p>
        <img
      ...
      <section>
        ...
        <p>
          Each statement inside a conditional block should have the same
          indentation (spacing).
        </p>
        <h3>Wrong Code</h3>
        <CodeBlock
      ...
      <section>
        ...
        <p>
          When If-Else conditional statement is used, Else block of code
          executes if the condition is <code>False</code>
        </p>
        <img
      ...
      <section>
        ...
        <p>
          <b>Warning:</b> No code is allowed in between if conditional block and
          else statement.
        </p>
      </section>
