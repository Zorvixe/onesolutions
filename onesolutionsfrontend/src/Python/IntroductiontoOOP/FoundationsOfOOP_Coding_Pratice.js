...
const FoundationsOfOOP_Coding_Pratice = () => {
  ...
  useEffect(() => {
    const practice90 = codingPracticesData.python.find(
      (p) => p.id === "Coding-practice-python-OOPCore-01"
    );
    if (practice90) {
      setSelectedPractice(practice90);
      console.log("📝 Loaded practice with details:", {
        practiceId: practice90.id,
        goalName,
        courseName,
...
export default FoundationsOfOOP_Coding_Pratice;
