...
const Seq_Of_Instruction_Class = ({
  subtopicId,
  goalName,
  courseName,
  subtopic,
  moduleName = "Introduction to Python",
  topicName = "Sequence of Instructions",
  slidesUrl = "https://docs.google.com/presentation/d/1aJXoXDI7pN_Xke0ysgMbM6t8gbqZQXCM2l7twKDrzbg/embed",
}) => {
...
export default Seq_Of_Instruction_Class;
