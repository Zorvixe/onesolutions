...
const Problem_Solving_Part_1_Class = ({
  subtopicId,
  goalName,
  courseName,
  subtopic,
  moduleName = "Nested Conditions",
  topicName = "Problem Solving Part 1",
  videoUrl = "https://www.youtube.com/embed/",
  slidesUrl = "https://docs.google.com/presentation/d/1R2_i_c1ae5wUmuS3Z-_UR6h-C1WKbJK5P8z3p2_KwCE/embed",
}) => {
...
export default Problem_Solving_Part_1_Class;
