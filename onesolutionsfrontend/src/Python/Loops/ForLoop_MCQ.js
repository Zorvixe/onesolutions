...
const questionsData = [
...

  {
    ...
    options: ["[2, 4, 6, 8]", "[2, 4, 6]", "range(8, 2, -2)", "range(4)"],
    answer: "[2, 4, 6]",
  },

  {
    question: "Which loop will print numbers from 1 to 5?",
    options: ["range(5)", "range(1, 6)", "range(1, 5)", "range(6)"],
    answer: "range(1, 6)",
  },
];

const ForLoop_MCQ = ({ subtopicId, goalName, courseName }) => {
  ...
  return <MCQLogic title="For Loop - Master MCQs" questions={shuffled} isCompleted={isCompleted}
