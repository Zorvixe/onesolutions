...
const InputOutputBasics = ({ subtopicId, goalName, courseName, subtopic }) => {
  ...
  return (
    <div className="intro-container">
      ...
      <section>
        ...
        <p>
          * operator is used for repeating strings any number of times as
          required.
        </p>
        <h3>Code</h3>
        <CodeBlock
      ...
      <section>
        ...
        <p>
          input() allows flexibility to take the input from the user. input()
      ...
      <section>
        ...
        <p>
          We can access an individual character in a string using their
          positions (which start from 0). These positions are also called as
          index.
        </p>
        <h3>Code</h3>
        <CodeBlock
