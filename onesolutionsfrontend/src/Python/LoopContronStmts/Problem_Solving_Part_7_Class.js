...
const Problem_Solving_Part_7_Class = ({
  subtopicId,
  goalName,
  courseName,
  subtopic,
  moduleName = "Loop Control Statements",
  topicName = "Problem Solving Part 7",
  videoUrl = "https://www.youtube.com/embed/",
  slidesUrl = "https://docs.google.com/presentation/d/1fAeae0lfIOajD0fjqXUvFqOX6b17i-1CEtz2WXi9EBQ/embed",
}) => {
...
export default Problem_Solving_Part_7_Class;
