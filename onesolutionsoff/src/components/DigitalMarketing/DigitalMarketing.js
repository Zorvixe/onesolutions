        ...
        <div className="container_digital_marketing">
          <div className="hero_content_digital_marketing">
            ...
            <h1 className="hero_title_digital_marketing">
              Master{" "}
              <span className="gradient_text_digital_marketing">
                Digital Marketing
              </span>
              <br />
            ...
            <p className="hero_subtitle_digital_marketing">
              Transform brands with cutting-edge digital strategies. Master SEO,
              SEM, social media, content marketing, and analytics to drive real
              business growth.
            </p>
            ...
            <div className="hero_stats_digital_marketing">
              <div className="stat_item_digital_marketing">
                ...
                <span className="stat_label_digital_marketing">
                  Students Certified
                </span>
              </div>
              <div className="stat_item_digital_marketing">
            ...
            <div className="code_terminal_digital_marketing">
              <div className="terminal_header_digital_marketing">
                ...
                <span className="terminal_title_digital_marketing">
                  OneSolutions_Campaign.js
                </span>
              </div>
      ...
      <section className="features_digital_marketing">
        <div className="container_digital_marketing">
          <div className="section_header_digital_marketing">
            <h2 className="section_title_digital_marketing">
              Why Choose Our Digital Marketing Program
            </h2>
            <p className="section_subtitle_digital_marketing">
              Get certified with hands-on experience in the most in-demand
          ...
          <div className="features_grid_digital_marketing">
            <div className="feature_card_digital_marketing">
              ...
              <h3 className="feature_title_digital_marketing">
                Live Campaign Management
              </h3>
              <p className="feature_description_digital_marketing">
                Work on real client campaigns with budget allocation and
                performance tracking
              </p>
              <div className="feature_highlight_digital_marketing">
                Real Projects
              </div>
            </div>
            ...
            <div className="feature_card_digital_marketing">
              ...
              <h3 className="feature_title_digital_marketing">
                Industry Tools Certification
              </h3>
              <p className="feature_description_digital_marketing">
                Get certified on Google Analytics, Ads, Facebook Blueprint, and
                more industry tools
              </p>
              <div className="feature_highlight_digital_marketing">
                Certifications
            ...
            <div className="feature_card_digital_marketing">
              ...
              <p className="feature_description_digital_marketing">
                Build a professional portfolio with 5+ successful campaign case
                studies
              </p>
              <div className="feature_highlight_digital_marketing">
                Case Studies
      ...
      <section className="tech_stack_digital_marketing">
        <div className="container_digital_marketing">
          <div className="section_header_digital_marketing">
            ...
            <p className="section_subtitle_digital_marketing">
              Learn the most in-demand digital marketing platforms and
              technologies
            </p>
          </div>
          ...
          <div className="tech_showcase_digital_marketing">
            ...
            <div className="tech_category_card_digital_marketing">
              ...
              <div className="tech_items_digital_marketing">
                <span className="tech_item_digital_marketing">
                  Google Analytics
                </span>
                <span className="tech_item_digital_marketing">
      ...
      <section className="curriculum_full_stack">
        <div className="container_full_stack">
          <div className="section_header_full_stack">
            ...
            <p className="section_subtitle_digital_marketing">
              4-6 months intensive program covering all aspects of digital
              marketing
            </p>
          </div>
          ...
          <div className="curriculum_timeline_full_stack">
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Introduction to digital marketing, consumer behavior, and
                  marketing funnel
                </p>
                <div className="timeline_duration_digital_marketing">
                  Weeks 1-3
                </div>
              </div>
            </div>
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Keyword research, on-page/off-page SEO, content strategy, and
                  blogging
                </p>
                <div className="timeline_duration_digital_marketing">
                  Weeks 4-7
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Platform strategies, content creation, community management,
                  and analytics
                </p>
                <div className="timeline_duration_digital_marketing">
                  Weeks 8-10
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Google Ads, social media advertising, retargeting, and
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Data analysis, ROI measurement, marketing strategy, and client
                  presentation
                </p>
                <div className="timeline_duration_digital_marketing">
                  Weeks 15-18
          ...
          <div className="projects_showcase_digital_marketing">
            <div className="project_card_digital_marketing">
              ...
              <div className="project_details_digital_marketing">
                ...
                <p>
                  Complete SEO overhaul for an online store resulting in 200%
                ...
                <div className="project_tech_stack_digital_marketing">
                  ...
                  <span className="tech_badge_digital_marketing">
                    Analytics
                  </span>
                </div>
            ...
            <div className="project_card_digital_marketing">
              ...
              <div className="project_details_digital_marketing">
                ...
                <p>
                  Viral social media campaign generating 50K+ engagements and
                  500+ leads
                </p>
                <div className="project_tech_stack_digital_marketing">
            ...
            <div className="project_card_digital_marketing">
              ...
              <div className="project_details_digital_marketing">
                ...
                <p>
                  PPC campaign with 300% ROI and 50% reduction in customer
                  acquisition cost
                </p>
                <div className="project_tech_stack_digital_marketing">
                  <span className="tech_badge_digital_marketing">
      ...
      <section className="learning_path_digital_marketing">
        <div className="container_digital_marketing">
          <div className="section_header_digital_marketing">
            ...
            <p className="section_subtitle_digital_marketing">
              Follow our proven 5-step methodology to become a successful
              digital marketer
            </p>
          </div>
          ...
          <div className="journey_steps_digital_marketing">
            ...
            <div className="step_card_digital_marketing">
              ...
              <h3>Get Certified</h3>
              <p>
                Earn industry-recognized certifications from Google, Facebook,
                and more
              </p>
            </div>
            ...
            <div className="step_card_digital_marketing">
              ...
              <p>
                Create case studies that demonstrate your ability to drive
                results
              </p>
            </div>
            ...
            <div className="step_card_digital_marketing">
              ...
              <h3>Land Your Job</h3>
              <p>
                Secure positions at top agencies or in-house marketing teams
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container_digital_marketing">
          ...
          <div className="pricing_cards_digital_marketing">
            <div className="pricing_card_digital_marketing">
              ...
              <a href="/enroll" className="pricing_cta_digital_marketing">
                Enroll Now
              </a>
            </div>

            <div className="pricing_card_digital_marketing featured_digital_marketing">
              <div className="featured_badge_digital_marketing">
                Most Popular
              </div>
              <div className="pricing_header_digital_marketing">
          ...
          <div className="pricing_guarantee_digital_marketing">
            <div className="guarantee_content_digital_marketing">
              ...
              <div>
                ...
                <p>
                  We're committed to your success. Get certified and receive
                  placement support until you land your dream marketing job.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container_digital_marketing">
          ...
          <div className="faq_container_digital_marketing">
            {[
              {
                question:
                  "Do I need any marketing background to join this course?",
                answer:
                  "No prior marketing experience is required! Our curriculum is designed for complete beginners and covers everything from fundamentals to advanced strategies. We've successfully trained people from diverse backgrounds including engineers, graduates, and career changers.",
              },
              {
                question:
                  "What certifications will I receive after completing the course?",
                answer:
                  "You'll receive the OneSolutions Digital Marketing Certification along with preparation for industry certifications like Google Analytics, Google Ads, Facebook Blueprint, and more. These certifications significantly boost your resume and credibility.",
              },
              {
                question: "Will I get to work on real campaigns?",
                answer:
                  "Absolutely! Our program includes hands-on projects with real budgets. You'll manage actual campaigns for mock clients or non-profits, giving you practical experience that employers value highly.",
              },
              {
                question:
                  "What kind of job roles can I apply for after completion?",
                answer:
                  "Graduates typically secure roles as Digital Marketing Specialists, SEO Analysts, Social Media Managers, PPC Specialists, Content Marketers, and Marketing Coordinators at both agencies and in-house marketing teams.",
              },
              {
                question:
                  "How long does it take to complete the course and see results?",
                answer:
                  "The program is designed to be completed in 4-6 months with part-time study. Many students start seeing tangible results from their campaign projects within the first 2-3 months of the program.",
              },
            ].map((faq, index) => (
              <div
                key={index}
                className={`faq_item_digital_marketing ${
                  activeFAQ === index ? "active_digital_marketing" : ""
                }`}
              >
                <div
      ...
      <section className="final_cta_digital_marketing">
        <div className="container_digital_marketing">
          <div className="cta_content_digital_marketing">
            <h2 className="cta_title_digital_marketing">
            ...
            <div className="cta_urgency_digital_marketing">
              <span className="urgency_text_digital_marketing">
                ⚡ Limited seats available - Only 20 spots left!
              </span>
            </div>
            <div className="cta_buttons_digital_marketing">
              <a
                href="#"
                className="btn_primary_digital_marketing large_digital_marketing"
              >
