        ...
        <div className="container_data_analyst">
          <div className="hero_content_data_analyst">
            ...
            <h1 className="hero_title_data_analyst">
              Master{" "}
              <span className="gradient_text_data_analyst">Data Analytics</span>
              <br />
              Unlock Insights That Drive Decisions
            </h1>
            <p className="hero_subtitle_data_analyst">
              Transform raw data into actionable insights. Master SQL, Python,
              Tableau, and machine learning to become an in-demand data analyst
            ...
            <div className="hero_stats_data_analyst">
              <div className="stat_item_data_analyst">
                ...
                <span className="stat_label_data_analyst">
                  Analysts Certified
                </span>
              </div>
              <div className="stat_item_data_analyst">
            ...
            <div className="code_terminal_data_analyst">
              <div className="terminal_header_data_analyst">
                ...
                <span className="terminal_title_data_analyst">
                  OneSolutions_Analysis.py
                </span>
              </div>
...
print(result)`}
      ...
      <section className="features_data_analyst">
        <div className="container_data_analyst">
          <div className="section_header_data_analyst">
            <h2 className="section_title_data_analyst">
              Why Choose Our Data Analyst Program
            </h2>
            <p className="section_subtitle_data_analyst">
              Gain practical experience with real-world datasets and industry
              tools
            </p>
          </div>
          ...
          <div className="features_grid_data_analyst">
            <div className="feature_card_data_analyst">
              <div className="feature_icon_container_data_analyst">
                ...
                >
                  <path
                    fill="white"
                    d="M64 64C46.3 64 32 78.3 32 96L32 416C32 433.7 46.3 448 64 448L128 448L128 480C128 497.7 142.3 512 160 512L288 512C305.7 512 320 497.7 320 480L320 448L384 448C401.7 448 416 433.7 416 416L416 96C416 78.3 401.7 64 384 64L64 64zM288 448L160 448L160 480L288 480L288 448zM96 128C96 110.3 110.3 96 128 96C145.7 96 160 110.3 160 128C160 145.7 145.7 160 128 160C110.3 160 96 145.7 96 128zM256 128C256 145.7 270.3 160 288 160C305.7 160 320 145.7 320 128C320 110.3 305.7 96 288 96C270.3 96 256 110.3 256 128zM96 224C96 206.3 110.3 192 128 192C145.7 192 160 206.3 160 224C160 241.7 145.7 256 128 256C110.3 256 96 241.7 96 224zM256 224C256 241.7 270.3 256 288 256C305.7 256 320 241.7 320 224C320 206.3 305.7 192 288 192C270.3 192 256 206.3 256 224zM96 320C96 302.3 110.3 288 128 288C145.7 288 160 302.3 160 320C160 337.7 145.7 352 128 352C110.3 352 96 337.7 96 320zM256 320C256 337.7 270.3 352 288 352C305.7 352 320 337.7 320 320C320 302.3 305.7 288 288 288C270.3 288 256 302.3 256 320z"
                  />
                </svg>
              </div>
              <h3 className="feature_title_data_analyst">Real Datasets</h3>
              <p className="feature_description_data_analyst">
                Work with actual business datasets from various industries
                including finance, healthcare, and e-commerce
              </p>
              <div className="feature_highlight_data_analyst">
            ...
            <div className="feature_card_data_analyst">
              ...
              <p className="feature_description_data_analyst">
                Master Python, SQL, Tableau, Power BI, Excel, and statistical
                analysis tools used by professionals
              </p>
            ...
            <div className="feature_card_data_analyst">
              ...
              <p className="feature_description_data_analyst">
                Build 5+ comprehensive data analysis projects that demonstrate
            ...
            <div className="feature_card_data_analyst">
              ...
              <p className="feature_description_data_analyst">
                100% placement assistance with resume building, interview
                preparation, and company connections
              </p>
      ...
      <section className="tech_stack_data_analyst">
        <div className="container_data_analyst">
          <div className="section_header_data_analyst">
            ...
            <p className="section_subtitle_data_analyst">
              Learn the most in-demand tools and technologies used by data
              analysts worldwide
            </p>
          </div>
          ...
          <div className="tech_showcase_data_analyst">
            ...
            <div className="tech_category_card_data_analyst">
              ...
              <div className="tech_items_data_analyst">
                ...
                <span className="tech_item_data_analyst">
                  Predictive Modeling
                </span>
      ...
      <section className="curriculum_full_stack">
        <div className="container_full_stack">
          <div className="section_header_full_stack">
            <h2 className="section_title_full_stack">
          ...
          <div className="curriculum_timeline_full_stack">
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Statistics basics, data types, Excel functions, and
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Database design, SQL queries, joins, subqueries, and data
                  extraction
                </p>
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Pandas, NumPy, data manipulation, cleaning, and exploratory
                  analysis
                </p>
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                <h3>Data Visualization</h3>
                <p>
                  Tableau, Power BI, creating dashboards, and storytelling with
                  data
                </p>
                <div className="timeline_duration_data_analyst">
                  Weeks 15-18
                </div>
              </div>
            </div>
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Machine learning basics, A/B testing, and comprehensive
                  capstone projects
                </p>
                <div className="timeline_duration_data_analyst">
                  Weeks 19-24
          ...
          <div className="projects_showcase_data_analyst">
            <div className="project_card_data_analyst">
              ...
              <div className="project_details_data_analyst">
                ...
                <p>
                  Interactive Tableau dashboard analyzing sales trends, regional
            ...
            <div className="project_card_data_analyst">
              ...
              <div className="project_details_data_analyst">
                ...
                <p>
                  Python-based clustering analysis to identify customer segments
            ...
            <div className="project_card_data_analyst">
              ...
              <div className="project_details_data_analyst">
                ...
                <p>
                  Machine learning model to predict future sales based on
      ...
      <section className="learning_path_data_analyst">
        <div className="container_data_analyst">
          <div className="section_header_data_analyst">
            <h2 className="section_title_data_analyst">
              Your Data Analyst Journey
            </h2>
            <p className="section_subtitle_data_analyst">
              Follow our proven 5-step methodology to become a successful data
              analyst
            </p>
          </div>
          ...
          <div className="journey_steps_data_analyst">
            ...
            <div className="step_card_data_analyst">
              ...
              <h3>Master Tools</h3>
              <p>
                Become proficient in SQL, Python, and data visualization
                platforms
              </p>
            </div>
            ...
            <div className="step_card_data_analyst">
              ...
              <p>
                Complete real-world projects that showcase your analytical
                skills
              </p>
            </div>
            ...
            <div className="step_card_data_analyst">
              ...
              <p>
                Practice technical interviews and case studies with industry
                experts
              </p>
            </div>
            ...
            <div className="step_card_data_analyst">
              ...
              <h3>Land Your Job</h3>
              <p>
                Secure positions as data analyst, business analyst, or insights
                analyst
              </p>
            </div>
          </div>
        ...
        <div className="container_data_analyst">
          ...
          <div className="pricing_cards_data_analyst">
            <div className="pricing_card_data_analyst">
              ...
              <a href="/enroll" className="pricing_cta_data_analyst">
                Enroll Now
              </a>
            </div>
          ...
          <div className="pricing_guarantee_data_analyst">
            <div className="guarantee_content_data_analyst">
              ...
              <div>
                ...
                <p>
                  We're committed to your success. Receive placement support
                  until you land your dream data analyst job.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container_data_analyst">
          ...
          <div className="faq_container_data_analyst">
            {[
              {
                question:
                  "Do I need a technical background to become a data analyst?",
                answer:
                  "No technical background is required! Our curriculum starts from absolute basics and is designed for complete beginners. We've successfully trained individuals from diverse backgrounds including commerce, arts, and humanities. What's important is your curiosity about data and willingness to learn.",
              },
              {
                question:
                  "What kind of job roles can I apply for after this course?",
                answer:
                  "Graduates typically secure roles as Data Analysts, Business Analysts, Reporting Analysts, Marketing Analysts, Operations Analysts, and Insights Analysts across various industries like IT, finance, healthcare, e-commerce, and consulting firms.",
              },
              {
                question: "Will I get to work with real datasets?",
                answer:
                  "Absolutely! Throughout the course, you'll work with real-world datasets from various industries. You'll analyze sales data, customer behavior, financial metrics, and operational data - exactly the kind of data you'll encounter in real jobs.",
              },
              {
                question: "How much Python and SQL do I need to learn?",
                answer:
                  "We cover Python and SQL comprehensively from basics to advanced levels. You'll learn enough to perform complex data analysis, build predictive models, write sophisticated SQL queries, and automate data processes - everything needed for an entry-level to mid-level data analyst position.",
              },
              {
                question:
                  "What makes your data analyst course different from others?",
                answer:
                  "Our course focuses on practical, job-ready skills rather than just theoretical concepts. You'll build a portfolio of 5+ real projects, receive personalized career guidance, and get placement assistance with our network of 35+ hiring partners. Our instructors are industry professionals who bring real-world experience to the classroom.",
              },
            ].map((faq, index) => (
              <div
                key={index}
                className={`faq_item_data_analyst ${
                  activeFAQ === index ? "active_data_analyst" : ""
                }`}
              >
                <div
      ...
      <section className="final_cta_data_analyst">
        <div className="container_data_analyst">
          <div className="cta_content_data_analyst">
            <h2 className="cta_title_data_analyst">
            ...
            <div className="cta_urgency_data_analyst">
              <span className="urgency_text_data_analyst">
                📊 Limited seats available - Only 18 spots left!
              </span>
            </div>
            <div className="cta_buttons_data_analyst">
              <a
                href="#"
                className="btn_primary_data_analyst large_data_analyst"
              >
