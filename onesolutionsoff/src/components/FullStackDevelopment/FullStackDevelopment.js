        ...
        <div className="container_full_stack">
          <div className="hero_content_full_stack">
            ...
            <h1 className="hero_title_full_stack">
              Master{" "}
              <span className="gradient_text_full_stack">
            ...
            <p className="hero_subtitle_full_stack">
              Transform your career with our comprehensive Java & Python Full
              Stack program. Build real-world projects, master cutting-edge
              technologies, and land your dream job.
            </p>
        ...
        <div className="container_full_stack">
          <div className="section_header_full_stack">
            <h2 className="section_title_full_stack">
              Why Choose OneSolutions
            </h2>
            <p className="section_subtitle_full_stack">
              Experience the difference with our industry-leading full stack
              development program
            </p>
          </div>
          ...
          <div className="features_grid_full_stack">
            <div className="feature_card_full_stack">
              ...
              <h3 className="feature_title_full_stack">
                Live Interactive Training
              </h3>
              <p className="feature_description_full_stack">
                Learn through hands-on coding sessions with real-time feedback
                and instant doubt resolution
              </p>
              <div className="feature_highlight_full_stack">
                Real-time Learning
              </div>
            </div>
            ...
            <div className="feature_card_full_stack">
              ...
              <p className="feature_description_full_stack">
                Participate in hackathons and mock interviews designed by
            ...
            <div className="feature_card_full_stack">
              ...
              <p className="feature_description_full_stack">
                Build 6+ production-ready projects that showcase your expertise
                to top employers
              </p>
            ...
            <div className="feature_card_full_stack">
              ...
              <p className="feature_description_full_stack">
                100% placement assistance with unlimited support until you land
                your dream job
              </p>
      ...
      <section className="tech_stack_full_stack">
        <div className="container_full_stack">
          <div className="section_header_full_stack">
            ...
            <p className="section_subtitle_full_stack">
              Learn the most in-demand technologies used by Fortune 500
              companies
            </p>
          </div>
          ...
          <div className="curriculum_timeline_full_stack">
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Programming fundamentals, OOP concepts, data structures, and
                  algorithms
                </p>
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Spring Framework, Spring Boot, Hibernate, and enterprise
                  development
                </p>
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  HTML5, CSS3, JavaScript, React.js, and modern UI/UX principles
                </p>
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  SQL, NoSQL databases, cloud deployment, Docker, and CI/CD
                  pipelines
                </p>
            ...
            <div className="timeline_item_full_stack">
              ...
              <div className="timeline_content_full_stack">
                ...
                <p>
                  Build real-world applications and prepare for placement
                  interviews
                </p>
      ...
      <section className="projects_full_stack">
        <div className="container_full_stack">
          <div className="section_header_full_stack">
            ...
            <p className="section_subtitle_full_stack">
              Create an impressive portfolio with these industry-standard
              applications
            </p>
          </div>
          ...
          <div className="projects_showcase_full_stack">
            <div className="project_card_full_stack">
              ...
              <div className="project_details_full_stack">
                ...
                <p>
                  Enterprise banking solution with advanced security features
            ...
            <div className="project_card_full_stack">
              ...
              <div className="project_details_full_stack">
                ...
                <p>
                  Collaborative workspace for teams with task tracking and
                  real-time updates
                </p>
                <div className="project_tech_stack_full_stack">
        ...
        <div className="container_full_stack">
          ...
          <div className="journey_steps_full_stack">
            <div className="step_card_full_stack">
              ...
              <div className="step_icon_full_stack">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 640 640"
                  width="30"
        ...
        <div className="container_full_stack">
          ...
          <div className="pricing_cards_full_stack">
            <div className="pricing_card_full_stack">
              ...
              <a href="/enroll" className="pricing_cta_full_stack">
                Enroll Now
              </a>
            </div>
          ...
          <div className="pricing_guarantee_full_stack">
            <div className="guarantee_content_full_stack">
              ...
              <div>
                ...
                <p>
                  We're committed to your success. Get unlimited placement
                  support until you land your dream job.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container_full_stack">
          ...
          <div className="faq_container_full_stack">
            {[
              {
                question:
                  "How do I enroll in the OneSolutions Full Stack program?",
                answer:
                  "Simply click on the 'Enroll Now' button, fill out the registration form, and complete the payment process. Our team will contact you within 24 hours to guide you through the onboarding process and provide access to our learning platform.",
              },
              {
                question: "What is the duration and schedule of the course?",
                answer:
                  "The program runs for 6-8 months with flexible scheduling options. For online students, we offer evening batches (7-9 PM) and weekend intensive sessions. Offline students can choose from morning (9 AM-12 PM) or afternoon (2-5 PM) batches.",
              },
              {
                question: "Do I need any prior programming experience?",
                answer:
                  "No programming experience is required! Our curriculum starts from absolute basics and gradually progresses to advanced concepts. We've successfully trained complete beginners and helped them land jobs at top companies.",
              },
              {
                question: "What kind of placement assistance do you provide?",
                answer:
                  "We offer comprehensive placement support including resume building, mock interviews, soft skills training, and direct connections with 50+ hiring partners. Our placement team works with you until you secure a job that meets your career goals.",
              },
              {
                question: "Can I access course materials after completion?",
                answer:
                  "Yes! You get lifetime access to all course materials, recorded sessions, project resources, and our alumni community. We also provide free access to updated content and new technology modules as they're added.",
              },
            ].map((faq, index) => (
              <div
                key={index}
                className={`faq_item_full_stack ${
                  activeFAQ === index ? "active_full_stack" : ""
                }`}
              >
                <div
      ...
      <section className="final_cta_full_stack">
        <div className="container_full_stack">
          <div className="cta_content_full_stack">
            <h2 className="cta_title_full_stack">
            ...
            <div className="cta_urgency_full_stack">
              <span className="urgency_text_full_stack">
                ⚡ Limited seats available - Only 25 spots left!
              </span>
            </div>
