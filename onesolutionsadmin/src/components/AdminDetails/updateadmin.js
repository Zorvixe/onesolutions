...
const UpdateAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://backend-lt9m.onrender.com/api/admin/update", {
        method: "PUT",
        headers: {
  ...
  const handleImageChange = async (e) => {
    ...
    if (selectedFile) {
      ...
      if (imageUrl) {
        setAdminDetails((prevData) => ({ ...prevData, admin_image_link: imageUrl }));
      }
  ...
  return (
    <div className="profile-body">
      ...
      <div style={{ padding: "20px", maxWidth: "100%" }} className="profile-container">
        <p className="profile-heading">Profile</p>
        <form onSubmit={handleSubmit}>
          <div className="profile-image-container">
            <label>Photo</label>
            <div className="profile-image-border-container">
              <img src={adminDetails.admin_image_link} className="image-profile" />
              <input
                type="file"
                accept="image/*"
              ...
              <label htmlFor="image" className="upload_icon-profile-contianer">
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-cloud-arrow-up arrow-uploader" viewBox="0 0 16 16">
