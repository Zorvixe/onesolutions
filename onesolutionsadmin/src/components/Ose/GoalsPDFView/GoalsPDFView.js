        ...
        modules: [
          ...
          },
          {
            ...
            topic: [
              ...
              {
                id: "QW9_s7_A0 m6_H g3_7B c4_D2E",
...
// GoalsPDFView Component
const GoalsPDFView = ({ onSelectSubtopic }) => {
                  ...
                  <div key={course.id} className="clvm-course-section">
                    ...
                    >
                      <div className="clvm-course-title">
                        ...
                        <h4>{course.title}</h4>
                        <span className="clvm-course-progress">
                          {course.progress}%
                        </span>
                      </div>
                    </div>
