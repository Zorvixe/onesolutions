...
import { X, Plus, Trash2, Check, HelpCircle, Users } from 'lucide-react';
...
const JavaMCQCreator = ({ subtopicId, onClose, onSuccess, editData = null }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditing) {
        url = `https://api.onesolutionsekam.in/admin/java/content/${editData.id}`;
        method = 'PUT';
        body = {
          content_type: 'mcq',
          mcq_title: title,
        ...
        url = `https://api.onesolutionsekam.in/admin/java/subtopics/${subtopicId}/mcq`;
        method = 'POST';
        body = {
          title,
          questions: payloadQuestions,
      ...
      <div className="mcq-creator-modal">
        ...
        <div className="mcq-creator-content">
          <form id="mcq-creator-form" onSubmit={handleSubmit} className="mcq-creator-form">
            ...
            <div className="mcq-creator-title-section">
              <label className="mcq-creator-field-label">
                Access for Student Types <span className="mcq-creator-required">*</span>
              </label>
